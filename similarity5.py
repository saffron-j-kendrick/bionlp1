...
dev_model_configs = {'meta-llama/Meta-Llama-3-8B' : (AutoConfig.from_pretrained("meta-llama/Meta-Llama-3-8B", token = access_token), AutoModelForCausalLM.from_pretrained("meta-llama/Meta-Llama-3-8B", token = access_token), AutoTokenizer.from_pretrained("meta-llama/Meta-Llama-3-8B", token = access_token) , 'meta-llama/Meta-Llama-3-8B'),
                     'aaditya/Llama3-OpenBioLLM-8B' : (AutoConfig.from_pretrained("aaditya/Llama3-OpenBioLLM-8B", token = access_token), AutoModelForCausalLM.from_pretrained("aaditya/Llama3-OpenBioLLM-8B", token = access_token), AutoTokenizer.from_pretrained("aaditya/Llama3-OpenBioLLM-8B", token = access_token), 'aaditya/Llama3-OpenBioLLM-8B'),
                     'meta-llama/Meta-Llama-3-8B-Instruct' : (AutoConfig.from_pretrained("meta-llama/Meta-Llama-3-8B-Instruct", token = access_token), AutoModelForCausalLM.from_pretrained("meta-llama/Meta-Llama-3-8B-Instruct", token = access_token), AutoTokenizer.from_pretrained("meta-llama/Meta-Llama-3-8B-Instruct", token = access_token), 'meta-llama/Meta-Llama-3-8B-Instruct'),
                     ...
                     'bionlp/bluebert_pubmed_uncased_L-12_H-768_A-12' : (AutoConfig.from_pretrained("bionlp/bluebert_pubmed_uncased_L-12_H-768_A-12"), AutoModel.from_pretrained("bionlp/bluebert_pubmed_uncased_L-12_H-768_A-12"), AutoTokenizer.from_pretrained("bionlp/bluebert_pubmed_uncased_L-12_H-768_A-12"), 'bionlp/bluebert_pubmed_uncased_L-12_H-768_A-12'),
                     'google-bert/bert-base-uncased' : (AutoConfig.from_pretrained("google-bert/bert-base-uncased"), AutoModel.from_pretrained("google-bert/bert-base-uncased"), AutoTokenizer.from_pretrained("google-bert/bert-base-uncased"), 'google-bert/bert-base-uncased'),
                     'microsoft/MediPhi-Instruct' : (AutoConfig.from_pretrained("microsoft/MediPhi-Instruct", trust_remote_code=True), AutoModelForCausalLM.from_pretrained("microsoft/MediPhi-Instruct", trust_remote_code=True), AutoTokenizer.from_pretrained("microsoft/MediPhi-Instruct", trust_remote_code=True), 'microsoft/MediPhi-Instruct'),
                     'microsoft/Phi-3.5-mini-instruct' : (AutoConfig.from_pretrained("microsoft/Phi-3.5-mini-instruct", trust_remote_code=True), AutoModelForCausalLM.from_pretrained("microsoft/Phi-3.5-mini-instruct", trust_remote_code=True), AutoTokenizer.from_pretrained("microsoft/Phi-3.5-mini-instruct", trust_remote_code=True), 'microsoft/Phi-3.5-mini-instruct'),
                     'BioMistral/BioMistral-7B' : (AutoConfig.from_pretrained("BioMistral/BioMistral-7B", token = access_token), AutoModelForCausalLM.from_pretrained("BioMistral/BioMistral-7B", token = access_token), AutoTokenizer.from_pretrained("BioMistral/BioMistral-7B", token = access_token), 'BioMistral/BioMistral-7B'),
                     'mistralai/Mistral-7B-Instruct-v0.1' : (AutoConfig.from_pretrained("mistralai/Mistral-7B-Instruct-v0.1", token = access_token), AutoModelForCausalLM.from_pretrained("mistralai/Mistral-7B-Instruct-v0.1", token = access_token), AutoTokenizer.from_pretrained("mistralai/Mistral-7B-Instruct-v0.1", token = access_token), 'mistralai/Mistral-7B-Instruct-v0.1'),
                     'meta-llama/Llama-2-7b-hf' : (AutoConfig.from_pretrained("meta-llama/Llama-2-7b-hf", token = access_token), AutoModelForCausalLM.from_pretrained("meta-llama/Llama-2-7b-hf", token = access_token), AutoTokenizer.from_pretrained("meta-llama/Llama-2-7b-hf", token = access_token), 'meta-llama/Llama-2-7b-hf'),
                     'epfl-llm/meditron-7b' : (AutoConfig.from_pretrained("epfl-llm/meditron-7b", token = access_token), AutoModelForCausalLM.from_pretrained("epfl-llm/meditron-7b", token = access_token), AutoTokenizer.from_pretrained("epfl-llm/meditron-7b", token = access_token), 'epfl-llm/meditron-7b'),
                     ...
                     'google-bert/bert-base-cased' : (AutoConfig.from_pretrained("google-bert/bert-base-cased"), AutoModelForMaskedLM.from_pretrained("google-bert/bert-base-cased"), AutoTokenizer.from_pretrained("google-bert/bert-base-cased"), 'google-bert/bert-base-cased')}
...
for model_name in tqdm.tqdm(models):
    ...
    if model_name in ['google/multiberts-seed_3', 'FacebookAI/roberta-base', 'dmis-lab/biobert-base-cased-v1.2', 'marcev/financebert', 'google-bert/bert-base-uncased', 'google-bert/bert-base-cased', 'bionlp/bluebert_pubmed_uncased_L-12_H-768_A-12']:
...
# all_sims_12_finance = np.load('data/all_sims_12_tarun7r_Finance-Llama-8B_test_with_difference.npy')
...
# all_sims_12_finance_primes = np.load('data/all_sims_12_primes_tarun7r_Finance-Llama-8B_test_with_difference.npy')
...
# ttest_p_values_finance = [ttest_rel(all_sims_12_finance[l], all_sims_12_llama[l], alternative='greater').pvalue for l in layer_x]
# sig_labels_finance = [sig_stars(p) for p in ttest_p_values_finance]
...
# ttest_p_values_finance_primes = [ttest_rel(all_sims_12_finance_primes[l], all_sims_12_llama_primes[l], alternative='greater').pvalue for l in layer_x]
# sig_labels_finance_primes = [sig_stars(p) for p in ttest_p_values_finance_primes]
...
# sig_x_finance = [l for l, lbl in enumerate(sig_labels_finance) if lbl]
# sig_x_primes = [l for l, lbl in enumerate(sig_labels_primes) if lbl]
# sig_x_finance_primes = [l for l, lbl in enumerate(sig_labels_finance_primes) if lbl]
# if sig_x_orig:
#     axes[0].plot(sig_x_orig, [0.0] * len(sig_x_orig), marker='*', linestyle='none',
#                  color='mediumpurple', markersize=5, label='BioLlama > Llama', zorder=5)
# if sig_x_finance:
#     axes[0].plot(sig_x_finance, [0.0] * len(sig_x_finance), marker='*', linestyle='none',
#                  color='deepskyblue', markersize=5, label='FinanceLlama > Llama', zorder=5)
# if sig_x_primes:
#     axes[1].plot(sig_x_primes, [0.0] * len(sig_x_primes), marker='*', linestyle='none',
#                  color='mediumpurple', markersize=5, label='BioLlama > Llama', zorder=5)
# if sig_x_finance_primes:
#     axes[1].plot(sig_x_finance_primes, [0.0] * len(sig_x_finance_primes), marker='*', linestyle='none',
#                  color='deepskyblue', markersize=5, label='FinanceLlama > Llama', zorder=5)
...
# ── Per-model full-diff figures ──────────────────────────────────────────────
# (sim(B,A) - sim(B,C)) + (sim(B',A') - sim(B',C'))

_full_diff_models = [
    ('ContactDoctor_Bio-Medical-Llama-3-8B', 'Bio-Medical-Llama', 'mediumpurple'),
    ('tarun7r_Finance-Llama-8B',             'Finance-Llama',     'deepskyblue'),
    ('meta-llama_Meta-Llama-3-8B',           'Llama',             'chartreuse'),
]

fig = plt.figure(figsize=(ACL_TEXT_WIDTH, ACL_SINGLE_HEIGHT))
ax = fig.gca()
for model_name_save, model_label, color in _full_diff_models:
    CosSim_full = np.load(f'data/CosSim_12_full_diff_{model_name_save}_test_with_difference.npy')
    ax.plot(CosSim_full, color=color, label=model_label)

ax.axhline(0, color='grey', linewidth=0.6, linestyle='--')
ax.set_xlabel('Layer')
ax.set_ylabel('Combined Cosine Similarity Difference')
ax.set_title('(sim(B,A)−sim(B,C)) + (sim(B′,A′)−sim(B′,C′))')
ax.legend(loc='best')
fig.tight_layout(rect=[0.04, 0.04, 1.0, 0.93])
fig.savefig('figures/CosSim_full_diff_all_llama.png')
fig.savefig('figures/CosSim_full_diff_all_llama.eps')
fig.savefig('figures/CosSim_full_diff_all_llama.pdf')
plt.show()
plt.close(fig)
